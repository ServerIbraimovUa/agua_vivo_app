import{u as b,d as j,j as i,a as K,s as it,b as Me,c as ie,e as ot,r as G,f as qe,M as ce,g as pe,I as B,h as st,i as ct,k as He,l as ut,m as dt,L as lt,n as L,o as ht,p as Ce,O as mt}from"./index-03JgU4Be.js";import{B as Ue,a as Xe,b as Qe,c as ft,d as pt,e as gt}from"./BottleHomeDesk-WtSqiB-E.js";const bt=b.div``,xt=b.form`
  display: flex;
  gap: 24px;
...
`,xr=()=>{const t=K(qe),{entries:r}=K(pe),n=r.reduce((e,{waterVolume:a})=>e+=a,0);return t?Math.floor(n/(t*1e3)*100):0},vr=()=>{const[t,r]=G.useState(!1),n=xr(),e=n>100?100:n,a=()=>{r(!1)};return i.jsxs(i.Fragment,{children:[i.jsx(sr,{children:i.jsxs(cr,{children:[i.jsxs("div",{children:[i.jsx(dr,{children:"Today"}),i.jsx(ur,{children:i.jsx(ke.Range,{disabled:!0,min:0,max:100,values:[e],onChange:()=>{},renderTrack:({props:o,children:s})=>i.jsx(lr,{...o,style:{...o.style,background:ke.getTrackBackground({values:[e],colors:["#9EBBFF","#D7E3FF"],min:0,max:100})},children:s}),renderThumb:({props:o})=>G.createElement(hr,{...o,key:o.key},i.jsx(mr,{children:i.jsxs(fr,{children:[e,"%"]})}))})}),i.jsxs(pr,{children:[e<=7?i.jsx("span",{children:" "}):i.jsx(ze,{children:"0%"}),e>=85?i.jsx("span",{children:" "}):i.jsx(ze,{children:"100%"})]})]}),i.jsx(gr,{className:"hover",children:i.jsxs(br,{className:"btn",onClick:()=>r(!0),children:[i.jsx(B,{className:"water-ratio-plus",id:"plus-circle"}),"Add Water"]})})]})}),t&&i.jsx(ce,{setVisible:r,title:"Add water",children:i.jsx(nt,{title:"Choose a value",show:!1,closeModal:a})})]})},wr=b.section`
...
`,Tr=()=>{const t=ie();return G.useEffect(()=>{t(ht())},[t]),i.jsx(wr,{children:i.jsx("div",{className:"container",children:i.jsxs(yr,{children:[i.jsxs(kr,{children:[i.jsx(At,{}),i.jsx(vr,{})]}),i.jsxs(Mr,{children:[i.jsx(Zn,{}),i.jsxs("div",{className:"mont-box",children:[i.jsx(Ce,{to:"/home",children:i.jsx(B,{className:"month-icon",id:"date"})}),i.jsx(Ce,{to:"/home/graf",children:i.jsx(B,{className:"month-icon",id:"chart"})})]}),i.jsx(mt,{})]})]})})})};export{Tr as default};

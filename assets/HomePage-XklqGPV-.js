import{u as m,d as E,j as t,a as G,s as Re,b as Me,c as ee,e as Ee,r as F,f as Ne,M as Q,g as te,I as q,h as Ce,i as _e,k as Ie,L as Fe,l as Ae,m as V,n as Pe}from"./index-zmCu-I1E.js";const ze=m.div``,Be=m.form`
...
`,ne=r=>r.water,Te=te(ne,r=>r.amountDaily),lt=te(ne,r=>r.amountDaily.percentage);te(ne,r=>r.amountMonthly);const dt=te(ne,r=>r.isLoading),ut=te(ne,r=>r.error),ue=({title:r,show:s,closeModal:i,_id:e})=>{const{register:n,handleSubmit:a,formState:{errors:l}}=Me(),u=ee(),[d,j]=F.useState({count:0,inputValue:"0"}),{entries:b}=G(Te),f=b.find(x=>x._id===e),[g,R]=F.useState([]);F.useEffect(()=>{const x=new Date,B=x.getMinutes(),L=x.getHours()>=12?"PM":"AM",P=(x.getHours()%12||12).toString().padStart(2,"0"),N=B.toString().padStart(2,"0"),U=`${P}:${N} ${L}`,Z=x.getHours(),W=x.getMinutes();let o=Z,c=Math.ceil(W/5)*5;c>=60&&(o++,c-=60);const p=[];for(let v=o*60+c;v<24*60;v+=5){const k=(v%60).toString().padStart(2,"0"),w=Math.floor(v/60)<12?"AM":"PM",S=(Math.floor(v/60)%12||12).toString().padStart(2,"0");p.push(`${S}:${k} ${w}`)}R([U,...p])},[]);const y=x=>{d.count+x>=0&&j({inputValue:String(x),count:x})},C=x=>{const{value:B}=x.target;j(L=>({...L,inputValue:B}))},h=()=>{y(Number(d.inputValue))},D=x=>{x.key==="-"&&x.preventDefault()},O=x=>{const B={time:x.time,waterVolume:Number(d.inputValue)};u(Ce(B)),i()};return t.jsxs(st,{children:[s&&t.jsxs("div",{className:"water-card",children:[t.jsx(q,{className:"water-glass-icon",id:"water"}),t.jsxs("p",{className:"water-amount-card",children:[f==null?void 0:f.waterVolume," ml"]}),t.jsx("p",{className:"time",children:f==null?void 0:f.time})]}),t.jsx("h2",{className:"add-water-title",children:r}),t.jsxs("div",{className:"counter-box",children:[t.jsx("p",{className:"",children:"Amount of water:"}),t.jsxs("div",{className:"counter-btn-box",children:[t.jsx("button",{className:"counter-btn",onClick:()=>y(d.count-50),type:"button",children:t.jsx(q,{className:"icon-minus",id:"minus"})}),t.jsxs("span",{className:"water-amount-span",children:[d.count,"ml"]}),t.jsx("button",{className:"counter-btn",onClick:()=>y(d.count+50),type:"button",children:t.jsx(q,{className:"icon-plus",id:"plus"})})]})]}),t.jsxs("form",{className:"add-water-form",onSubmit:a(O),children:[t.jsxs("label",{className:"water-label",children:[t.jsx("span",{children:"Recording time:"}),t.jsx("select",{...n("time",{required:!0}),name:"time",className:"water-input","aria-label":"Time",children:g.map(x=>t.jsx("option",{value:x,children:x},x))}),l.time&&t.jsx("span",{children:"This field is required"})]}),t.jsxs("label",{className:"water-label",children:[t.jsx("span",{className:"enter-water-span",children:"Enter the value of water used:"}),t.jsx("input",{...n("waterVolume",{required:!0}),type:"number",min:0,max:5e3,step:50,name:"waterVolume",value:d.inputValue,onChange:C,onBlur:h,onKeyPress:D,className:"water-input"}),l.waterVolume&&t.jsx("span",{children:"This field is required"})]}),t.jsxs("div",{className:"btn-container",children:[t.jsxs("span",{className:"water-amount",children:[d.count,"ml"]}),t.jsx("button",{type:"submit",className:"save-btn",children:"Save"})]})]})]})},pt=({closeModal:r,_id:s})=>{const i=ee(),e=()=>{r()},n=a=>{i(_e(a)),r()};return t.jsxs(ct,{children:[t.jsx("p",{children:"Are you sure you want to delete the entry?"}),t.jsxs("div",{className:"delete-btn-box",children:[t.jsx("button",{className:"cancel-btn",type:"button",onClick:e,children:"Cancel"}),t.jsx("button",{className:"delete-btn",type:"button",onClick:()=>n(s),children:"Delete"})]})]})},ht=({_id:r,waterVolume:s,time:i})=>{const[e,n]=F.useState(!1),[a,l]=F.useState(!1),u=ee(),d=j=>{u(Ie(j))};return t.jsxs(ot,{children:[t.jsxs("div",{className:"water-info",children:[t.jsx(q,{className:"water-glass-icon",id:"water"}),t.jsxs("p",{className:"water-amount-card",children:[s," ml"]}),t.jsx("p",{className:"time",children:i})]}),t.jsxs("div",{className:"edit-delete-btn-box",children:[t.jsx("button",{type:"button",className:"edit-btn",onClick:()=>n(!0),children:t.jsx(q,{className:"edit-water-icon",id:"pencil"})}),t.jsx("button",{type:"button",className:"delete-btn",onClick:()=>{l(!0)},children:t.jsx(q,{className:"delete-water-icon",id:"delete"})})]}),e&&t.jsx(Q,{setVisible:n,title:"Edit the entered amount of water",children:t.jsx(ue,{title:"Correct entered data:",show:!0,handleUpdateWater:d,closeModal:()=>{n(!1)},_id:r})}),a&&t.jsx(Q,{setVisible:l,title:"Delete water",children:t.jsx(pt,{title:"Delete entry?",show:!1,closeModal:()=>{l(!1)},_id:r})})]})},ft=()=>{const[r,s]=F.useState(!1),{entries:i}=G(Te),e=G(dt),n=G(ut),a=()=>{s(!1)};return F.useEffect(()=>{},[i]),t.jsxs(it,{children:[t.jsx("h3",{className:"water-title",children:"Today"}),e&&!n&&t.jsx(Fe,{}),i.length===0?t.jsx("p",{className:"water-empty",children:"No notes yet"}):t.jsx("ul",{className:"water-list",children:i.length>0&&i.map(({_id:l,waterVolume:u,time:d})=>t.jsx(ht,{_id:l,waterVolume:u,time:d},l))}),t.jsx("div",{children:t.jsxs("button",{className:"add-water-btn",onClick:()=>s(!0),children:[t.jsx(q,{className:"water-plus-icon",id:"plus"}),"Add water"]})}),r&&t.jsx(Q,{setVisible:s,title:"Add water",children:t.jsx(ue,{title:"Choose a value",show:!1,closeModal:a})})]})},mt=m.div`
            /* position: absolute;
            bottom: 0;
            right: 0; */
...
`,Bt=()=>{const[r,s]=F.useState(!1),i=G(lt),e=i>100?100:i,n=()=>{s(!1)};return t.jsxs(t.Fragment,{children:[t.jsx(Ot,{children:t.jsxs(Rt,{children:[t.jsxs("div",{children:[t.jsx(Nt,{children:"Today"}),t.jsx(Et,{children:t.jsx(de.Range,{disabled:!0,min:0,max:100,values:[e],onChange:()=>{},renderTrack:({props:a,children:l})=>t.jsx(Ct,{...a,style:{...a.style,background:de.getTrackBackground({values:[e],colors:["#9EBBFF","#D7E3FF"],min:0,max:100})},children:l}),renderThumb:({props:a})=>F.createElement(_t,{...a,key:a.key},t.jsx(It,{children:t.jsxs(Ft,{children:[e,"%"]})}))})}),t.jsxs(At,{children:[e<=7?t.jsx("span",{children:" "}):t.jsx(ke,{children:"0%"}),e>=85?t.jsx("span",{children:" "}):t.jsx(ke,{children:"100%"})]})]}),t.jsx(Pt,{className:"hover",children:t.jsxs(zt,{className:"btn",onClick:()=>s(!0),children:[t.jsx(q,{className:"water-ratio-plus",id:"plus-circle"}),"Add Water"]})})]})}),r&&t.jsx(Q,{setVisible:s,title:"Add water",children:t.jsx(ue,{title:"Choose a value",show:!1,closeModal:n})})]})},Lt="/agua_vivo_app/assets/BackgroundHomeMobile--bJS4c7V.png",$t="/agua_vivo_app/assets/BottleHomeMobile-YibEMZyu.png",Vt=m.section`
...
`,Ht=()=>{const r=ee();return F.useEffect(()=>{r(Pe())},[r]),t.jsx(Vt,{children:t.jsxs("div",{className:"container",children:[t.jsxs(Wt,{children:[t.jsx(at,{}),t.jsx(Bt,{})]}),t.jsxs("div",{className:"container-calendar",children:[t.jsx(ft,{}),t.jsx(yt,{})]})]})})};export{Ht as default};

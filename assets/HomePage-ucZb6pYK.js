import{u as L,d as _,a as fe,s as fi,b as ot,c as Te,j as o,e as pi,r as F,f as At,M as Se,g as We,I as z,h as hi,i as mi,k as zt,l as gi,m as vi,L as xi,n as K,R as Y,o as wi,p as wt,O as bi}from"./index-GEO-4IQm.js";import{P as lt,B as Rt,a as Ft,b as Bt,c as yi,d as Si,e as Ti}from"./BottleHomeDesk-UndE142u.js";const Ei=L.div``,Mi=L.form`
  display: flex;
  gap: 24px;
...
`,Er=()=>{const t=fe(At),{entries:e}=fe(We),i=e.reduce((n,{waterVolume:r})=>n+=r,0);return t?Math.floor(i/(t*1e3)*100):0},Mr=()=>{const[t,e]=F.useState(!1),i=Er(),n=i>100?100:i,r=()=>{e(!1)};return o.jsxs(o.Fragment,{children:[o.jsx(fr,{children:o.jsxs(pr,{children:[o.jsxs(hr,{className:"third-step",children:[o.jsx(gr,{children:"Today"}),o.jsx(mr,{children:o.jsx(it.Range,{disabled:!0,min:0,max:100,values:[n],onChange:()=>{},renderTrack:({props:s,children:l})=>o.jsx(vr,{...s,style:{...s.style,background:it.getTrackBackground({values:[n],colors:["#9EBBFF","#D7E3FF"],min:0,max:100})},children:l}),renderThumb:({props:s})=>F.createElement(xr,{...s,key:s.key},o.jsx(wr,{children:o.jsxs(br,{children:[n,"%"]})}))})}),o.jsxs(yr,{children:[n<=7?o.jsx("span",{children:" "}):o.jsx(Ot,{children:"0%"}),n>=85?o.jsx("span",{children:" "}):o.jsx(Ot,{children:"100%"})]})]}),o.jsx(Sr,{className:"hover",children:o.jsxs(Tr,{className:"btn second-step",onClick:()=>e(!0),children:[o.jsx(z,{className:"water-ratio-plus",id:"plus-circle"}),"Add Water"]})})]})}),t&&o.jsx(Se,{setVisible:e,title:"Add water",children:o.jsx(qt,{title:"Choose a value",closeModal:r})})]})},jr=L.section`

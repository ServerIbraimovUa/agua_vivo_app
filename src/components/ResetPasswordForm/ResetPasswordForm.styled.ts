...
export const StyledResetPassSection = styled.section`
...
`;
export const StyledResetPassDiv = styled.div`
  display: flex;
  flex-direction: column;
  max-width: 280px;
  min-height: 396px;
...
export const StyledResetPassFormSpan = styled.span`
  .eye-icon,
  .eye-outline-icon {
    top: 50%;
    right: 2px;
...
export const ResetPassFormButton = styled.button`
  width: 100%;
  height: 36px;
  border-radius: 10px;
  padding: 8px 30px;
